...
def compute_labels_accuracy():
    real_labels = glob.glob('src/data/solar_panels_experiments/labels/test/*.txt')
...
def main():
    ...
    #mname = 'yolov5s_100'
    mname = 'yolov5s_10_test'
    yolo_testing(
        name=f'{mname}_tiles2',
        source='../data/solar_panels_experiment/images/test',  # yolov5/data/solar_panels/tiles2
        project='results',
